...
RUN rpm-ostree install bspwm rofi fastfetch dmenu picom sxhkd nitrogen polybar brightnessctl pavucontrol alacritty neovim lxappearance spectacle python3-pip
